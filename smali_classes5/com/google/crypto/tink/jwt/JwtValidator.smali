...
.method private validateTimestampClaims(Lcom/google/crypto/tink/jwt/RawJwt;)V
    ...
    const-string/jumbo p1, "token does not have an expiration set"
    ...
    const-string/jumbo v1, "token has expired since "
    ...
    const-string/jumbo v1, "token cannot be used before "
    ...
    const-string/jumbo v1, "token has a invalid iat claim in the future: "
    ...
    const-string/jumbo p1, "token does not have an iat claim"
