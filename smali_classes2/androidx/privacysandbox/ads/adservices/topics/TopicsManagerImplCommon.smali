...
.method private final getTopicsAsyncInternal(Landroid/adservices/topics/GetTopicsRequest;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 30
    invoke-virtual {p0, p1, v2, v1}, Landroid/adservices/topics/TopicsManager;->getTopics(Landroid/adservices/topics/GetTopicsRequest;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V
...
.method public final convertResponse$ads_adservices_release(Landroid/adservices/topics/GetTopicsResponse;)Landroidx/privacysandbox/ads/adservices/topics/GetTopicsResponse;
    ...
    check-cast v0, Landroid/adservices/topics/Topic;

    .line 50
    new-instance v7, Landroidx/privacysandbox/ads/adservices/topics/Topic;

    invoke-virtual {v0}, Landroid/adservices/topics/Topic;->getTaxonomyVersion()J

    move-result-wide v2

    invoke-virtual {v0}, Landroid/adservices/topics/Topic;->getModelVersion()J

    move-result-wide v4

    invoke-virtual {v0}, Landroid/adservices/topics/Topic;->getTopicId()I
