...
.method private isHostingProcess(Ljava/lang/String;Landroidx/test/internal/util/ProcSummary;)Z
    ...
    .line 981
    iget-object p0, p2, Landroidx/test/internal/util/ProcSummary;->cmdline:Ljava/lang/String;
    ...
    .line 999
    iget-object p0, p2, Landroidx/test/internal/util/ProcSummary;->name:Ljava/lang/String;
...
.method private isOriginalUncached()Z
    ...
    const-string v1, "Could not list apps for this user, running in sandbox? Assuming primary"
...
.method private setupDexmakerClassloader()V
    ...
    .line 290
    :cond_1
    iget-object p0, p0, Landroidx/test/runner/MonitoringInstrumentation;->isDexmakerClassLoaderInitialized:Ljava/lang/ThreadLocal;
...
.method private stubResultFor(Landroid/content/Intent;)Landroid/app/Instrumentation$ActivityResult;
    ...
    .line 695
    const-string v0, "Could not retrieve stub result for intent %s"
    ...
    invoke-interface {p0, p1}, Landroidx/test/runner/intent/IntentStubber;->getActivityResultForIntent(Landroid/content/Intent;)Landroid/app/Instrumentation$ActivityResult;
...
.method private tryLoadingJsBridge(Ljava/lang/String;)V
    ...
    const-string p1, "JsBridge class name cannot be null!"
...
.method public callActivityOnCreate(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    sget-object p2, Landroidx/test/runner/lifecycle/Stage;->CREATED:Landroidx/test/runner/lifecycle/Stage;

    invoke-virtual {p0, p2, p1}, Landroidx/test/internal/runner/lifecycle/ActivityLifecycleMonitorImpl;->signalLifecycleChange(Landroidx/test/runner/lifecycle/Stage;Landroid/app/Activity;)V
...
.method public callActivityOnDestroy(Landroid/app/Activity;)V
    ...
    sget-object v0, Landroidx/test/runner/lifecycle/Stage;->DESTROYED:Landroidx/test/runner/lifecycle/Stage;

    invoke-virtual {p0, v0, p1}, Landroidx/test/internal/runner/lifecycle/ActivityLifecycleMonitorImpl;->signalLifecycleChange(Landroidx/test/runner/lifecycle/Stage;Landroid/app/Activity;)V
...
.method public callActivityOnStart(Landroid/app/Activity;)V
    ...
    .line 781
    iget-object p0, p0, Landroidx/test/runner/MonitoringInstrumentation;->startedActivityCounter:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public callApplicationOnCreate(Landroid/app/Application;)V
    ...
    .line 471
    iget-object p0, p0, Landroidx/test/runner/MonitoringInstrumentation;->applicationMonitor:Landroidx/test/internal/runner/lifecycle/ApplicationLifecycleMonitorImpl;

    sget-object v0, Landroidx/test/runner/lifecycle/ApplicationStage;->CREATED:Landroidx/test/runner/lifecycle/ApplicationStage;

    invoke-virtual {p0, p1, v0}, Landroidx/test/internal/runner/lifecycle/ApplicationLifecycleMonitorImpl;->signalLifecycleChange(Landroid/app/Application;Landroidx/test/runner/lifecycle/ApplicationStage;)V
...
.method public execStartActivity(Landroid/content/Context;Landroid/os/IBinder;Landroid/os/IBinder;Landroid/app/Activity;Landroid/content/Intent;I)Landroid/app/Instrumentation$ActivityResult;
    ...
    .line 570
    const-string p0, "Stubbing intent %s"
...
.method public finish(ILandroid/os/Bundle;)V
    ...
    .line 393
    const-string p0, "MonitoringInstr"
...
.method public newActivity(Ljava/lang/ClassLoader;Ljava/lang/String;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    .line 852
    iget-object p0, p0, Landroidx/test/runner/MonitoringInstrumentation;->interceptingActivityFactory:Landroidx/test/runner/intercepting/InterceptingActivityFactory;

    invoke-interface {p0, p1, p2, p3}, Landroidx/test/runner/intercepting/InterceptingActivityFactory;->create(Ljava/lang/ClassLoader;Ljava/lang/String;Landroid/content/Intent;)Landroid/app/Activity;
...
.method protected final setJsBridgeClassName(Ljava/lang/String;)V
    ...
    const-string p1, "JsBridge is already loaded!"
...
.method protected shouldWaitForActivitiesToComplete()Z
    ...
    const-string/jumbo v0, "waitForActivitiesToComplete"
...
.method public startActivitySync(Landroid/content/Intent;)Landroid/app/Activity;
    ...
    filled-new-array {p1, v3, v0, p0}, [Ljava/lang/Object;
