...
.method public declared-synchronized init(Landroid/app/Instrumentation;Landroidx/test/runner/MonitoringInstrumentation$ActivityFinisher;)V
    ...
    .line 166
    const-string/jumbo v0, "new_instrumentation_binder"
...
.method public declared-synchronized requestRemoteInstancesActivityCleanup()V
    ...
    const-string v0, "Timed out while attempting to perform activity clean up for "

    const-string v1, "Interrupted while waiting for response from message with id: "
    ...
    invoke-virtual {v3, v5}, Landroidx/test/internal/runner/InstrumentationConnection$IncomingHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v5, v3}, Landroidx/test/internal/runner/InstrumentationConnection$IncomingHandler;->sendMessage(Landroid/os/Message;)Z
    :try_end_0
