...
.method public __init(ILjava/nio/ByteBuffer;)V
    ...
    .line 14
    iput p1, p0, Lcom/newrelic/mobile/fbs/jserror/Thread;->bb_pos:I

    iput-object p2, p0, Lcom/newrelic/mobile/fbs/jserror/Thread;->bb:Ljava/nio/ByteBuffer;

    iget p1, p0, Lcom/newrelic/mobile/fbs/jserror/Thread;->bb_pos:I

    iget-object p2, p0, Lcom/newrelic/mobile/fbs/jserror/Thread;->bb:Ljava/nio/ByteBuffer;

    iget v0, p0, Lcom/newrelic/mobile/fbs/jserror/Thread;->bb_pos:I
    ...
    iput p1, p0, Lcom/newrelic/mobile/fbs/jserror/Thread;->vtable_start:I

    iget-object p1, p0, Lcom/newrelic/mobile/fbs/jserror/Thread;->bb:Ljava/nio/ByteBuffer;

    iget p2, p0, Lcom/newrelic/mobile/fbs/jserror/Thread;->vtable_start:I

    invoke-virtual {p1, p2}, Ljava/nio/ByteBuffer;->getShort(I)S

    move-result p1

    iput p1, p0, Lcom/newrelic/mobile/fbs/jserror/Thread;->vtable_size:I
...
.method public frames(Lcom/newrelic/mobile/fbs/jserror/Frame;I)Lcom/newrelic/mobile/fbs/jserror/Frame;
    ...
    .line 18
    invoke-virtual {p0, v0}, Lcom/newrelic/mobile/fbs/jserror/Thread;->__offset(I)I

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {p0, v1}, Lcom/newrelic/mobile/fbs/jserror/Thread;->__vector(I)I
    ...
    invoke-virtual {p0, v1}, Lcom/newrelic/mobile/fbs/jserror/Thread;->__indirect(I)I

    move-result p2

    iget-object p0, p0, Lcom/newrelic/mobile/fbs/jserror/Thread;->bb:Ljava/nio/ByteBuffer;

    invoke-virtual {p1, p2, p0}, Lcom/newrelic/mobile/fbs/jserror/Frame;->__assign(ILjava/nio/ByteBuffer;)Lcom/newrelic/mobile/fbs/jserror/Frame;
...
.method public framesLength()I
    ...
    invoke-virtual {p0, v0}, Lcom/newrelic/mobile/fbs/jserror/Thread;->__vector_len(I)I
