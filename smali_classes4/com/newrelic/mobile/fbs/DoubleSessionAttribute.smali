...
.method public static __lookup_by_key(Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;ILjava/lang/String;Ljava/nio/ByteBuffer;)Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;
    ...
    .line 50
    invoke-static {v3, p3}, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->__indirect(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {v4, v5, p3}, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->__offset(IILjava/nio/ByteBuffer;)I

    move-result v4

    invoke-static {v4, p2, p3}, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->compareStrings(I[BLjava/nio/ByteBuffer;)I
...
.method public __init(ILjava/nio/ByteBuffer;)V
    ...
    iget p1, p0, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->bb_pos:I

    iget-object p2, p0, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->bb:Ljava/nio/ByteBuffer;

    iget v0, p0, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->bb_pos:I
    ...
    iput p1, p0, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->vtable_start:I

    iget-object p1, p0, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->bb:Ljava/nio/ByteBuffer;

    iget p2, p0, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->vtable_start:I

    invoke-virtual {p1, p2}, Ljava/nio/ByteBuffer;->getShort(I)S

    move-result p1

    iput p1, p0, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->vtable_size:I
...
.method protected keysCompare(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/nio/ByteBuffer;)I
    ...
    invoke-static {p1, p0, p3}, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->__offset(IILjava/nio/ByteBuffer;)I
    ...
    invoke-static {p1, p2, p3}, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->__offset(IILjava/nio/ByteBuffer;)I

    move-result p1

    invoke-static {p0, p1, p3}, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->compareStrings(IILjava/nio/ByteBuffer;)I
...
.method public mutateValue(D)Z
    ...
    iget p0, p0, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->bb_pos:I
...
.method public nameInByteBuffer(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 19
    invoke-virtual {p0, p1, v0, v1}, Lcom/newrelic/mobile/fbs/DoubleSessionAttribute;->__vector_in_bytebuffer(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
