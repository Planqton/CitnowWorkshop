...
.source "InteractionTraceBundle.java"
...
.method public __init(ILjava/nio/ByteBuffer;)V
    ...
    .line 14
    iput p1, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->bb_pos:I

    iput-object p2, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->bb:Ljava/nio/ByteBuffer;

    iget p1, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->bb_pos:I

    iget-object p2, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->bb:Ljava/nio/ByteBuffer;

    iget v0, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->bb_pos:I
    ...
    iput p1, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->vtable_start:I

    iget-object p1, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->bb:Ljava/nio/ByteBuffer;

    iget p2, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->vtable_start:I

    invoke-virtual {p1, p2}, Ljava/nio/ByteBuffer;->getShort(I)S

    move-result p1

    iput p1, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->vtable_size:I
...
.method public accountId()I
    ...
    .line 17
    invoke-virtual {p0, v0}, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->__offset(I)I

    move-result v0

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->bb:Ljava/nio/ByteBuffer;

    iget p0, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->bb_pos:I
...
.method public countryCode()Ljava/lang/String;
    ...
    iget v1, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->bb_pos:I

    add-int/2addr v0, v1

    invoke-virtual {p0, v0}, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->__string(I)Ljava/lang/String;
...
.method public countryCodeAsByteBuffer()Ljava/nio/ByteBuffer;
    ...
    .line 24
    invoke-virtual {p0, v0, v1}, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->__vector_as_bytebuffer(II)Ljava/nio/ByteBuffer;
...
.method public countryCodeInByteBuffer(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 25
    invoke-virtual {p0, p1, v0, v1}, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->__vector_in_bytebuffer(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
...
.method public interactionTraces(Lcom/newrelic/mobile/fbs/models/InteractionTrace;I)Lcom/newrelic/mobile/fbs/models/InteractionTrace;
    ...
    invoke-virtual {p0, v0}, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->__vector(I)I
    ...
    invoke-virtual {p0, v0}, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->__indirect(I)I

    move-result p2

    iget-object p0, p0, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->bb:Ljava/nio/ByteBuffer;

    invoke-virtual {p1, p2, p0}, Lcom/newrelic/mobile/fbs/models/InteractionTrace;->__assign(ILjava/nio/ByteBuffer;)Lcom/newrelic/mobile/fbs/models/InteractionTrace;
...
.method public interactionTracesLength()I
    ...
    invoke-virtual {p0, v0}, Lcom/newrelic/mobile/fbs/models/InteractionTraceBundle;->__vector_len(I)I
