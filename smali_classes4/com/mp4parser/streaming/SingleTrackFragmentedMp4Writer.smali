...
.method private consumeSample(Lcom/mp4parser/streaming/StreamingSample;Ljava/nio/channels/WritableByteChannel;)V
    ...
    .line 248
    iget-object p0, p0, Lcom/mp4parser/streaming/SingleTrackFragmentedMp4Writer;->fragment:Ljava/util/List;
...
.method private createMoof()Lcom/coremedia/iso/boxes/Box;
    ...
    .line 258
    invoke-virtual {p0, v1}, Lcom/coremedia/iso/boxes/fragment/TrackRunBox;->setDataOffset(I)V
...
.method private createTraf(JLcom/coremedia/iso/boxes/fragment/MovieFragmentBox;)V
    ...
    .line 349
    iget-object p0, p0, Lcom/mp4parser/streaming/SingleTrackFragmentedMp4Writer;->source:Lcom/mp4parser/streaming/StreamingTrack;

    const-class p1, Lcom/mp4parser/streaming/extensions/CencEncryptTrackExtension;

    invoke-interface {p0, p1}, Lcom/mp4parser/streaming/StreamingTrack;->getTrackExtension(Ljava/lang/Class;)Lcom/mp4parser/streaming/TrackExtension;
...
.method protected createMdhd()Lcom/coremedia/iso/boxes/Box;
    ...
    invoke-interface {p0}, Lcom/mp4parser/streaming/StreamingTrack;->getLanguage()Ljava/lang/String;
...
.method protected createMdiaHdlr()Lcom/coremedia/iso/boxes/Box;
    ...
    invoke-interface {p0}, Lcom/mp4parser/streaming/StreamingTrack;->getHandler()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, Lcom/coremedia/iso/boxes/HandlerBox;->setHandlerType(Ljava/lang/String;)V
...
.method protected createMvex()Lcom/coremedia/iso/boxes/Box;
    ...
    invoke-virtual {v0, p0}, Lcom/coremedia/iso/boxes/fragment/MovieExtendsBox;->addBox(Lcom/coremedia/iso/boxes/Box;)V
...
.method protected createMvhd()Lcom/coremedia/iso/boxes/Box;
    ...
    invoke-interface {p0}, Lcom/mp4parser/streaming/StreamingTrack;->getTimescale()J
...
.method protected createStbl()Lcom/coremedia/iso/boxes/Box;
    ...
    invoke-interface {p0}, Lcom/mp4parser/streaming/StreamingTrack;->getSampleDescriptionBox()Lcom/coremedia/iso/boxes/SampleDescriptionBox;

    move-result-object p0

    invoke-virtual {v0, p0}, Lcom/coremedia/iso/boxes/SampleTableBox;->addBox(Lcom/coremedia/iso/boxes/Box;)V
...
.method protected createTfhd(Lcom/coremedia/iso/boxes/fragment/TrackFragmentBox;)V
    ...
    invoke-interface {p0, v1}, Lcom/mp4parser/streaming/StreamingTrack;->getTrackExtension(Ljava/lang/Class;)Lcom/mp4parser/streaming/TrackExtension;

    move-result-object p0

    check-cast p0, Lcom/mp4parser/streaming/extensions/TrackIdTrackExtension;

    if-eqz p0, :cond_0

    .line 273
    invoke-virtual {p0}, Lcom/mp4parser/streaming/extensions/TrackIdTrackExtension;->getTrackId()J
    ...
    .line 277
    invoke-virtual {v0, p0}, Lcom/coremedia/iso/boxes/fragment/TrackFragmentHeaderBox;->setDefaultBaseIsMoof(Z)V
...
.method protected createTrex()Lcom/coremedia/iso/boxes/Box;
    ...
    .line 186
    invoke-virtual {v1, p0}, Lcom/coremedia/iso/boxes/fragment/SampleFlags;->setSampleDependsOn(I)V

    .line 187
    invoke-virtual {v1, p0}, Lcom/coremedia/iso/boxes/fragment/SampleFlags;->setSampleIsDependedOn(I)V
