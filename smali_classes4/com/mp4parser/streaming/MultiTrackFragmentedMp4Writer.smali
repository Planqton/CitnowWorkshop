...
.method public constructor <init>([Lcom/mp4parser/streaming/StreamingTrack;Ljava/io/OutputStream;)V
    ...
    .line 98
    const-class v3, Lcom/mp4parser/streaming/extensions/TrackIdTrackExtension;

    invoke-interface {p2, v3}, Lcom/mp4parser/streaming/StreamingTrack;->getTrackExtension(Ljava/lang/Class;)Lcom/mp4parser/streaming/TrackExtension;
    ...
    .line 101
    new-instance v5, Lcom/mp4parser/streaming/extensions/TrackIdTrackExtension;
    ...
    :goto_2
    invoke-direct {v5, v6, v7}, Lcom/mp4parser/streaming/extensions/TrackIdTrackExtension;-><init>(J)V

    invoke-interface {p2, v5}, Lcom/mp4parser/streaming/StreamingTrack;->addTrackExtension(Lcom/mp4parser/streaming/TrackExtension;)V
    ...
    .line 89
    const-class v5, Lcom/mp4parser/streaming/extensions/TrackIdTrackExtension;

    invoke-interface {v4, v5}, Lcom/mp4parser/streaming/StreamingTrack;->getTrackExtension(Ljava/lang/Class;)Lcom/mp4parser/streaming/TrackExtension;
    ...
    check-cast v4, Lcom/mp4parser/streaming/extensions/TrackIdTrackExtension;

    .line 92
    invoke-virtual {v4}, Lcom/mp4parser/streaming/extensions/TrackIdTrackExtension;->getTrackId()J
...
.method private declared-synchronized consumeSample(Lcom/mp4parser/streaming/StreamingTrack;Lcom/mp4parser/streaming/StreamingSample;)V
    ...
    .line 307
    iget-wide v0, p0, Lcom/mp4parser/streaming/MultiTrackFragmentedMp4Writer;->currentTime:J
    ...
    iput-wide v0, p0, Lcom/mp4parser/streaming/MultiTrackFragmentedMp4Writer;->currentTime:J

    .line 309
    iget-object v0, p0, Lcom/mp4parser/streaming/MultiTrackFragmentedMp4Writer;->fragmentBuffers:Ljava/util/Map;
...
.method private createMfhd(JLcom/coremedia/iso/boxes/fragment/MovieFragmentBox;)V
    ...
    .line 465
    invoke-virtual {p3, p0}, Lcom/coremedia/iso/boxes/fragment/MovieFragmentBox;->addBox(Lcom/coremedia/iso/boxes/Box;)V
...
.method private createTraf(Lcom/mp4parser/streaming/StreamingTrack;Lcom/coremedia/iso/boxes/fragment/MovieFragmentBox;)V
    ...
    .line 414
    const-class p0, Lcom/mp4parser/streaming/extensions/CencEncryptTrackExtension;

    invoke-interface {p1, p0}, Lcom/mp4parser/streaming/StreamingTrack;->getTrackExtension(Ljava/lang/Class;)Lcom/mp4parser/streaming/TrackExtension;
...
.method protected createDinf()Lcom/coremedia/iso/boxes/DataInformationBox;
    ...
    .line 188
    new-instance v0, Lcom/coremedia/iso/boxes/DataReferenceBox;

    invoke-direct {v0}, Lcom/coremedia/iso/boxes/DataReferenceBox;-><init>()V

    .line 189
    invoke-virtual {p0, v0}, Lcom/coremedia/iso/boxes/DataInformationBox;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 190
    new-instance v1, Lcom/coremedia/iso/boxes/DataEntryUrlBox;

    invoke-direct {v1}, Lcom/coremedia/iso/boxes/DataEntryUrlBox;-><init>()V

    const/4 v2, 0x1

    .line 191
    invoke-virtual {v1, v2}, Lcom/coremedia/iso/boxes/DataEntryUrlBox;->setFlags(I)V
...
.method public createFtyp()Lcom/coremedia/iso/boxes/Box;
    ...
    invoke-direct {v1, v0, v2, v3, p0}, Lcom/coremedia/iso/boxes/FileTypeBox;-><init>(Ljava/lang/String;JLjava/util/List;)V
...
.method protected createMdhd(Lcom/mp4parser/streaming/StreamingTrack;)Lcom/coremedia/iso/boxes/Box;
    ...
    .line 138
    iget-object p0, p0, Lcom/mp4parser/streaming/MultiTrackFragmentedMp4Writer;->creationTime:Ljava/util/Date;

    invoke-virtual {v0, p0}, Lcom/coremedia/iso/boxes/MediaHeaderBox;->setModificationTime(Ljava/util/Date;)V
    ...
    invoke-virtual {v0, p0}, Lcom/coremedia/iso/boxes/MediaHeaderBox;->setLanguage(Ljava/lang/String;)V
...
.method protected createMvhd()Lcom/coremedia/iso/boxes/Box;
    ...
    .line 120
    iget-object p0, p0, Lcom/mp4parser/streaming/MultiTrackFragmentedMp4Writer;->source:[Lcom/mp4parser/streaming/StreamingTrack;
    ...
    .line 121
    invoke-interface {v6}, Lcom/mp4parser/streaming/StreamingTrack;->getTimescale()J
...
.method protected createStbl(Lcom/mp4parser/streaming/StreamingTrack;)Lcom/coremedia/iso/boxes/Box;
    ...
    .line 175
    new-instance p0, Lcom/coremedia/iso/boxes/SampleTableBox;

    invoke-direct {p0}, Lcom/coremedia/iso/boxes/SampleTableBox;-><init>()V
    ...
    invoke-virtual {p0, p1}, Lcom/coremedia/iso/boxes/SampleTableBox;->addBox(Lcom/coremedia/iso/boxes/Box;)V
...
.method protected createTfhd(Lcom/mp4parser/streaming/StreamingTrack;Lcom/coremedia/iso/boxes/fragment/TrackFragmentBox;)V
    ...
    .line 341
    invoke-virtual {p0, v0}, Lcom/coremedia/iso/boxes/fragment/TrackFragmentHeaderBox;->setDefaultSampleFlags(Lcom/coremedia/iso/boxes/fragment/SampleFlags;)V

    const-wide/16 v0, -0x1

    .line 342
    invoke-virtual {p0, v0, v1}, Lcom/coremedia/iso/boxes/fragment/TrackFragmentHeaderBox;->setBaseDataOffset(J)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/coremedia/iso/boxes/fragment/TrackFragmentHeaderBox;->setTrackId(J)V
    ...
    .line 345
    invoke-virtual {p2, p0}, Lcom/coremedia/iso/boxes/fragment/TrackFragmentBox;->addBox(Lcom/coremedia/iso/boxes/Box;)V
...
.method protected createTrex(Lcom/mp4parser/streaming/StreamingTrack;)Lcom/coremedia/iso/boxes/Box;
    ...
    .line 238
    invoke-virtual {v0, p1}, Lcom/coremedia/iso/boxes/fragment/SampleFlags;->setSampleDependsOn(I)V

    .line 239
    invoke-virtual {v0, p1}, Lcom/coremedia/iso/boxes/fragment/SampleFlags;->setSampleIsDependedOn(I)V

    .line 241
    :cond_1
    invoke-virtual {p0, v0}, Lcom/coremedia/iso/boxes/fragment/TrackExtendsBox;->setDefaultSampleFlags(Lcom/coremedia/iso/boxes/fragment/SampleFlags;)V
...
.method protected createTrun(Lcom/mp4parser/streaming/StreamingTrack;Lcom/coremedia/iso/boxes/fragment/TrackFragmentBox;)V
    ...
    .line 370
    iget-object p0, p0, Lcom/mp4parser/streaming/MultiTrackFragmentedMp4Writer;->fragmentBuffers:Ljava/util/Map;
    ...
    check-cast p1, Lcom/mp4parser/streaming/StreamingSample;
    ...
    .line 372
    invoke-interface {p1}, Lcom/mp4parser/streaming/StreamingSample;->getContent()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v3, v4, v5}, Lcom/coremedia/iso/boxes/fragment/TrackRunBox$Entry;->setSampleSize(J)V

    if-eqz v1, :cond_3

    .line 375
    const-class v4, Lcom/mp4parser/streaming/extensions/SampleFlagsSampleExtension;

    invoke-static {p1, v4}, Lcom/mp4parser/streaming/StreamingSampleHelper;->getSampleExtension(Lcom/mp4parser/streaming/StreamingSample;Ljava/lang/Class;)Lcom/mp4parser/streaming/SampleExtension;
    ...
    invoke-virtual {v5, v6}, Lcom/coremedia/iso/boxes/fragment/SampleFlags;->setIsLeading(B)V
    ...
    invoke-virtual {v5, v6}, Lcom/coremedia/iso/boxes/fragment/SampleFlags;->setSampleIsDependedOn(I)V
    ...
    invoke-virtual {v5, v6}, Lcom/coremedia/iso/boxes/fragment/SampleFlags;->setSampleHasRedundancy(I)V
    ...
    invoke-virtual {v5, v6}, Lcom/coremedia/iso/boxes/fragment/SampleFlags;->setSamplePaddingValue(I)V
    ...
    invoke-virtual {v5, v4}, Lcom/coremedia/iso/boxes/fragment/SampleFlags;->setSampleDegradationPriority(I)V

    .line 386
    invoke-virtual {v3, v5}, Lcom/coremedia/iso/boxes/fragment/TrackRunBox$Entry;->setSampleFlags(Lcom/coremedia/iso/boxes/fragment/SampleFlags;)V
    ...
    invoke-virtual {v3, v4, v5}, Lcom/coremedia/iso/boxes/fragment/TrackRunBox$Entry;->setSampleDuration(J)V
    ...
    .line 394
    const-class v4, Lcom/mp4parser/streaming/extensions/CompositionTimeSampleExtension;

    invoke-static {p1, v4}, Lcom/mp4parser/streaming/StreamingSampleHelper;->getSampleExtension(Lcom/mp4parser/streaming/StreamingSample;Ljava/lang/Class;)Lcom/mp4parser/streaming/SampleExtension;

    move-result-object p1

    check-cast p1, Lcom/mp4parser/streaming/extensions/CompositionTimeSampleExtension;

    .line 396
    invoke-virtual {p1}, Lcom/mp4parser/streaming/extensions/CompositionTimeSampleExtension;->getCompositionTimeOffset()I

    move-result p1

    invoke-virtual {v3, p1}, Lcom/coremedia/iso/boxes/fragment/TrackRunBox$Entry;->setSampleCompositionTimeOffset(I)V
