...
.method private gaSpecificConfigSize()I
    ...
    .line 740
    iget p0, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->extensionFlag3:I
...
.method private parseGaSpecificConfig(IIILcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/BitReaderBuffer;)V
    ...
    const-string p1, "can\'t parse program_config_element yet"
...
.method private serializeConfigBytes()Ljava/nio/ByteBuffer;
    ...
    const-string v0, "can\'t write ELDSpecificConfig yet"
    ...
    const-string v0, "can\'t write SLSSpecificConfig yet"
    ...
    .line 914
    :pswitch_4
    iget p0, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->fillBits:I

    invoke-virtual {v1, p0, v9}, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/BitWriterBuffer;->writeBits(II)V

    .line 915
    new-instance p0, Ljava/lang/UnsupportedOperationException;

    const-string v0, "can\'t write ALSSpecificConfig yet"
    ...
    const-string v0, "can\'t write DSTSpecificConfig yet"
    ...
    const-string v0, "can\'t write MPEG_1_2_SpecificConfig yet"
    ...
    .line 899
    :pswitch_7
    iget p0, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->sacPayloadEmbedding:I

    invoke-virtual {v1, p0, v8}, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/BitWriterBuffer;->writeBits(II)V

    .line 900
    new-instance p0, Ljava/lang/UnsupportedOperationException;

    const-string v0, "can\'t write SpatialSpecificConfig yet"
    ...
    const-string v0, "can\'t write SSCSpecificConfig yet"
    ...
    const-string v0, "can\'t write parseParametricSpecificConfig yet"
    ...
    const-string v0, "can\'t write ErrorResilientHvxcSpecificConfig yet"
    ...
    const-string v0, "can\'t write ErrorResilientCelpSpecificConfig yet"
    ...
    const-string v0, "can\'t write StructuredAudioSpecificConfig yet"
    ...
    const-string v0, "can\'t write TTSSpecificConfig yet"
    ...
    const-string v0, "can\'t write HvxcSpecificConfig yet"
    ...
    const-string v0, "can\'t write CelpSpecificConfig yet"
    ...
    .line 989
    :cond_a
    iget p0, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->extensionChannelConfiguration:I

    invoke-virtual {v1, p0, v3}, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/BitWriterBuffer;->writeBits(II)V
...
.method private writeAudioObjectType(ILcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/BitWriterBuffer;)V
    ...
    .line 999
    invoke-virtual {p2, v1, p0}, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/BitWriterBuffer;->writeBits(II)V
    ...
    .line 1000
    invoke-virtual {p2, p1, p0}, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/BitWriterBuffer;->writeBits(II)V
...
.method public getAudioObjectType()I
    ...
    .line 1197
    iget p0, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->audioObjectType:I
...
.method getContentSize()I
    ...
    .line 760
    iget v6, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->extensionSamplingFrequencyIndex:I
    ...
    .line 774
    :cond_5
    iget v4, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->outerSyncExtensionType:I
    ...
    .line 778
    iget v6, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->extensionAudioObjectType:I
    ...
    .line 800
    iget p0, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->extensionSamplingFrequencyIndex:I
...
.method public getExtensionAudioObjectType()I
    ...
    .line 1209
    iget p0, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->extensionAudioObjectType:I
...
.method public getExtensionSamplingFrequency()I
    ...
    iget p0, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->extensionSamplingFrequency:I

    goto :goto_0

    :cond_0
    sget-object p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->samplingFrequencyIndexMap:Ljava/util/Map;
...
.method public getSamplingFrequency()I
    ...
    iget p0, p0, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/AudioSpecificConfig;->samplingFrequency:I
...
.method public parseDetail(Ljava/nio/ByteBuffer;)V
    ...
    const-string p1, "can\'t parse SymbolicMusicSpecificConfig yet"
    ...
    const-string p1, "can\'t parse SLSSpecificConfig yet"
    ...
    const-string p1, "can\'t parse ALSSpecificConfig yet"
    ...
    const-string p1, "can\'t parse DSTSpecificConfig yet"
    ...
    const-string p1, "can\'t parse MPEG_1_2_SpecificConfig yet"
    ...
    const-string p1, "can\'t parse SpatialSpecificConfig yet"
    ...
    const-string p1, "can\'t parse SSCSpecificConfig yet"
    ...
    const-string p1, "can\'t parse ErrorResilientHvxcSpecificConfig yet"
    ...
    const-string p1, "can\'t parse ErrorResilientCelpSpecificConfig yet"
    ...
    const-string p1, "can\'t parse StructuredAudioSpecificConfig yet"
    ...
    const-string p1, "can\'t parse TTSSpecificConfig yet"
    ...
    const-string p1, "can\'t parse HvxcSpecificConfig yet"
    ...
    const-string p1, "can\'t parse CelpSpecificConfig yet"
    ...
    const-string p1, "can\'t parse ErrorProtectionSpecificConfig yet"
