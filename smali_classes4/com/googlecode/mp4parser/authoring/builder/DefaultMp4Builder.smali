...
.method public build(Lcom/googlecode/mp4parser/authoring/Movie;)Lcom/coremedia/iso/boxes/Container;
    ...
    .line 141
    iget-object p0, p0, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->sampleAuxiliaryInformationOffsetsBoxes:Ljava/util/Set;
    ...
    .line 157
    :goto_7
    instance-of p0, v7, Lcom/coremedia/iso/boxes/Box;
    ...
    .line 164
    invoke-virtual {v0, p0}, Lcom/mp4parser/iso14496/part12/SampleAuxiliaryInformationOffsetsBox;->setOffsets([J)V
    ...
    .line 154
    :cond_5
    invoke-interface {p0}, Lcom/coremedia/iso/boxes/Box;->getSize()J
...
.method protected createCtts(Lcom/googlecode/mp4parser/authoring/Track;Lcom/coremedia/iso/boxes/SampleTableBox;)V
    ...
    .line 578
    invoke-virtual {p1, p0}, Lcom/coremedia/iso/boxes/CompositionTimeToSample;->setEntries(Ljava/util/List;)V
...
.method protected createSdtp(Lcom/googlecode/mp4parser/authoring/Track;Lcom/coremedia/iso/boxes/SampleTableBox;)V
    ...
    .line 559
    new-instance p0, Lcom/coremedia/iso/boxes/SampleDependencyTypeBox;

    invoke-direct {p0}, Lcom/coremedia/iso/boxes/SampleDependencyTypeBox;-><init>()V
    ...
    invoke-virtual {p0, p1}, Lcom/coremedia/iso/boxes/SampleDependencyTypeBox;->setEntries(Ljava/util/List;)V
...
.method protected createStco(Lcom/googlecode/mp4parser/authoring/Track;Lcom/googlecode/mp4parser/authoring/Movie;Ljava/util/Map;Lcom/coremedia/iso/boxes/SampleTableBox;)V
    ...
    .line 474
    sget-object v3, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->LOG:Lcom/googlecode/mp4parser/util/Logger;
    ...
    invoke-virtual {v3, v4}, Lcom/googlecode/mp4parser/util/Logger;->logDebug(Ljava/lang/String;)V
    ...
    .line 477
    new-instance v4, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder$1;

    invoke-direct {v4, v0}, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder$1;-><init>(Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;)V
    ...
    .line 507
    :cond_0
    iget-object v8, v0, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->chunkOffsetBoxes:Ljava/util/Map;
    ...
    .line 508
    invoke-virtual {v8}, Lcom/coremedia/iso/boxes/ChunkOffsetBox;->getChunkOffsets()[J
    ...
    invoke-static {v12, v13}, Lcom/googlecode/mp4parser/util/Mp4Arrays;->copyOfAndAppend([J[J)[J

    move-result-object v12

    invoke-virtual {v8, v12}, Lcom/coremedia/iso/boxes/ChunkOffsetBox;->setChunkOffsets([J)V
    ...
    .line 518
    :cond_1
    iget-object v9, v0, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->track2SampleSizes:Ljava/util/HashMap;
    ...
    .line 489
    iget-object v9, v0, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->chunkOffsetBoxes:Ljava/util/Map;

    new-instance v10, Lcom/coremedia/iso/boxes/StaticChunkOffsetBox;

    invoke-direct {v10}, Lcom/coremedia/iso/boxes/StaticChunkOffsetBox;-><init>()V
    ...
    invoke-virtual {v1, v0}, Lcom/coremedia/iso/boxes/SampleTableBox;->addBox(Lcom/coremedia/iso/boxes/Box;)V
...
.method protected createStsc(Lcom/googlecode/mp4parser/authoring/Track;Ljava/util/Map;Lcom/coremedia/iso/boxes/SampleTableBox;)V
    ...
    invoke-virtual {p1, p2}, Lcom/coremedia/iso/boxes/SampleToChunkBox;->setEntries(Ljava/util/List;)V
    ...
    .line 554
    invoke-virtual {p3, p1}, Lcom/coremedia/iso/boxes/SampleTableBox;->addBox(Lcom/coremedia/iso/boxes/Box;)V
    ...
    .line 550
    invoke-virtual {p1}, Lcom/coremedia/iso/boxes/SampleToChunkBox;->getEntries()Ljava/util/List;
...
.method protected createStsz(Lcom/googlecode/mp4parser/authoring/Track;Lcom/coremedia/iso/boxes/SampleTableBox;)V
    ...
    .line 533
    iget-object p0, p0, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->track2SampleSizes:Ljava/util/HashMap;
...
.method protected createTrackBox(Lcom/googlecode/mp4parser/authoring/Track;Lcom/googlecode/mp4parser/authoring/Movie;Ljava/util/Map;)Lcom/coremedia/iso/boxes/TrackBox;
    ...
    .line 324
    invoke-virtual {v3, p0}, Lcom/coremedia/iso/boxes/MediaInformationBox;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 325
    invoke-virtual {v1, v3}, Lcom/coremedia/iso/boxes/MediaBox;->addBox(Lcom/coremedia/iso/boxes/Box;)V

    .line 326
    sget-object p0, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->LOG:Lcom/googlecode/mp4parser/util/Logger;
    ...
    invoke-virtual {p0, p1}, Lcom/googlecode/mp4parser/util/Logger;->logDebug(Ljava/lang/String;)V
...
.method getChunkSizes(Lcom/googlecode/mp4parser/authoring/Track;)[I
    ...
    .line 609
    iget-object p0, p0, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->fragmenter:Lcom/googlecode/mp4parser/authoring/builder/Fragmenter;

    invoke-interface {p0, p1}, Lcom/googlecode/mp4parser/authoring/builder/Fragmenter;->sampleNumbers(Lcom/googlecode/mp4parser/authoring/Track;)[J
...
.method protected putSamples(Lcom/googlecode/mp4parser/authoring/Track;Ljava/util/List;)Ljava/util/List;
    ...
    .line 172
    iget-object p0, p0, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->track2Sample:Ljava/util/HashMap;
