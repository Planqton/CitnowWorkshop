.class public Ltvi/webrtc/voiceengine/WebRtcAudioEffects;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->AOSP_ACOUSTIC_ECHO_CANCELER:Ljava/util/UUID;
    ...
    sput-object v0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->AOSP_NOISE_SUPPRESSOR:Ljava/util/UUID;
...
.method public static canUseAcousticEchoCanceler()Z
    ...
    .line 139
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->isAcousticEchoCancelerSupported()Z
    ...
    .line 140
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioUtils;->useWebRtcBasedAcousticEchoCanceler()Z
    ...
    .line 141
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->isAcousticEchoCancelerBlacklisted()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->isAcousticEchoCancelerExcludedByUUID()Z
...
.method public static canUseNoiseSuppressor()Z
    ...
    .line 149
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->isNoiseSuppressorSupported()Z
    ...
    .line 150
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioUtils;->useWebRtcBasedNoiseSuppressor()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->isNoiseSuppressorBlacklisted()Z
    ...
    .line 151
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->isNoiseSuppressorExcludedByUUID()Z
...
.method public static create()Ltvi/webrtc/voiceengine/WebRtcAudioEffects;
    .locals 1

    .line 157
    new-instance v0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;

    invoke-direct {v0}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;-><init>()V
...
.method private static getAvailableEffects()[Landroid/media/audiofx/AudioEffect$Descriptor;
    ...
    .line 297
    sget-object v0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->cachedEffects:[Landroid/media/audiofx/AudioEffect$Descriptor;
    ...
    sput-object v0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->cachedEffects:[Landroid/media/audiofx/AudioEffect$Descriptor;
...
.method public static isAcousticEchoCancelerBlacklisted()Z
    ...
    .line 77
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioUtils;->getBlackListedModelsForAecUsage()Ljava/util/List;
    ...
    invoke-static {v2, v1}, Ltvi/webrtc/Logging;->w(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static isAcousticEchoCancelerEffectAvailable()Z
    ...
    invoke-static {v0}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->isEffectTypeAvailable(Ljava/util/UUID;)Z
...
.method private static isAcousticEchoCancelerExcludedByUUID()Z
    ...
    .line 100
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->getAvailableEffects()[Landroid/media/audiofx/AudioEffect$Descriptor;
    ...
    sget-object v5, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->AOSP_ACOUSTIC_ECHO_CANCELER:Ljava/util/UUID;
...
.method public static isAcousticEchoCancelerSupported()Z
    ...
    .line 63
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->isAcousticEchoCancelerEffectAvailable()Z
...
.method public static isNoiseSuppressorBlacklisted()Z
    ...
    .line 87
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioUtils;->getBlackListedModelsForNsUsage()Ljava/util/List;
...
.method private static isNoiseSuppressorExcludedByUUID()Z
    ...
    sget-object v5, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->AOSP_NOISE_SUPPRESSOR:Ljava/util/UUID;
...
.method public static isNoiseSuppressorSupported()Z
    ...
    .line 72
    invoke-static {}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->isNoiseSuppressorEffectAvailable()Z
...
.method public enable(I)V
    ...
    .line 204
    iget-object v0, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->aec:Landroid/media/audiofx/AcousticEchoCanceler;
    ...
    :goto_0
    invoke-static {v0}, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->assertTrue(Z)V

    .line 205
    iget-object v0, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->ns:Landroid/media/audiofx/NoiseSuppressor;
    ...
    iput-object v0, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->aec:Landroid/media/audiofx/AcousticEchoCanceler;
    ...
    .line 227
    iget-boolean v8, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->shouldEnableAec:Z
    ...
    .line 228
    :goto_2
    iget-object v9, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->aec:Landroid/media/audiofx/AcousticEchoCanceler;
    ...
    invoke-static {v1, v9}, Ltvi/webrtc/Logging;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 233
    iget-object v8, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->aec:Landroid/media/audiofx/AcousticEchoCanceler;
    ...
    iput-object p1, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->ns:Landroid/media/audiofx/NoiseSuppressor;
    ...
    .line 245
    iget-boolean v0, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->shouldEnableNs:Z
    ...
    .line 250
    iget-object p0, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->ns:Landroid/media/audiofx/NoiseSuppressor;
...
.method public release()V
    ...
    .line 264
    iput-object v1, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->aec:Landroid/media/audiofx/AcousticEchoCanceler;
    ...
    .line 268
    iput-object v1, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->ns:Landroid/media/audiofx/NoiseSuppressor;
...
.method public setAEC(Z)Z
    ...
    .line 172
    iput-boolean v2, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->shouldEnableAec:Z
    ...
    iget-boolean v0, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->shouldEnableAec:Z
    ...
    .line 179
    :cond_1
    iput-boolean p1, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->shouldEnableAec:Z
...
.method public setNS(Z)Z
    ...
    .line 191
    iput-boolean v2, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->shouldEnableNs:Z
    ...
    .line 198
    :cond_1
    iput-boolean p1, p0, Ltvi/webrtc/voiceengine/WebRtcAudioEffects;->shouldEnableNs:Z
