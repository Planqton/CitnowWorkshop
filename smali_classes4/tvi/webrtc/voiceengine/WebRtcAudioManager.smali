...
.method constructor <init>(J)V
    ...
    invoke-static {v15, v1}, Ltvi/webrtc/Logging;->d(Ljava/lang/String;Ljava/lang/String;)V

    move-wide/from16 v13, p1

    .line 174
    iput-wide v13, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->nativeAudioManager:J
    ...
    iput-object v1, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->audioManager:Landroid/media/AudioManager;

    .line 180
    new-instance v2, Ltvi/webrtc/voiceengine/WebRtcAudioManager$VolumeLogger;

    invoke-direct {v2, v1}, Ltvi/webrtc/voiceengine/WebRtcAudioManager$VolumeLogger;-><init>(Landroid/media/AudioManager;)V

    iput-object v2, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->volumeLogger:Ltvi/webrtc/voiceengine/WebRtcAudioManager$VolumeLogger;

    .line 181
    invoke-direct/range {p0 .. p0}, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->storeAudioParameters()V

    .line 182
    iget v1, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->sampleRate:I

    iget v2, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->outputChannels:I

    iget v3, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->inputChannels:I

    iget-boolean v4, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->hardwareAEC:Z

    iget-boolean v5, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->hardwareAGC:Z

    iget-boolean v6, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->hardwareNS:Z

    iget-boolean v7, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->lowLatencyOutput:Z

    iget-boolean v8, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->lowLatencyInput:Z

    iget-boolean v9, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->proAudio:Z

    iget-boolean v10, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->aAudio:Z

    iget v11, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->outputBufferSize:I

    iget v12, v0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->inputBufferSize:I

    invoke-direct/range {v0 .. v14}, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->nativeCacheAudioParameters(IIIZZZZZZZIIJ)V

    .line 185
    invoke-static {v15}, Ltvi/webrtc/voiceengine/WebRtcAudioUtils;->logAudioState(Ljava/lang/String;)V
...
.method private dispose()V
    ...
    .line 205
    :cond_0
    iget-object p0, p0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->volumeLogger:Ltvi/webrtc/voiceengine/WebRtcAudioManager$VolumeLogger;

    invoke-static {p0}, Ltvi/webrtc/voiceengine/WebRtcAudioManager$VolumeLogger;->access$100(Ltvi/webrtc/voiceengine/WebRtcAudioManager$VolumeLogger;)V
...
.method private getLowLatencyOutputFramesPerBuffer()I
    ...
    .line 318
    iget-object p0, p0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->audioManager:Landroid/media/AudioManager;
...
.method private init()Z
    ...
    invoke-virtual {p0}, Ltvi/webrtc/voiceengine/WebRtcAudioManager$VolumeLogger;->start()V
...
.method private isDeviceBlacklistedForOpenSLESUsage()Z
    ...
    .line 213
    sget-boolean p0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->blacklistDeviceForOpenSLESUsageIsOverridden:Z

    if-eqz p0, :cond_0

    .line 214
    sget-boolean p0, Ltvi/webrtc/voiceengine/WebRtcAudioManager;->blacklistDeviceForOpenSLESUsage:Z
