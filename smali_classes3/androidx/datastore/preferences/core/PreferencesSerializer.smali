...
.method static constructor <clinit>()V
    ...
    .line 37
    const-string/jumbo v0, "preferences_pb"
...
.method private final getValueProto(Ljava/lang/Object;)Landroidx/datastore/preferences/PreferencesProto$Value;
    ...
    const-string/jumbo p1, "newBuilder().setBoolean(value).build()"
    ...
    const-string/jumbo p1, "newBuilder().setFloat(value).build()"
    ...
    const-string/jumbo p1, "newBuilder().setDouble(value).build()"
    ...
    const-string/jumbo p1, "newBuilder().setInteger(value).build()"
    ...
    const-string/jumbo p1, "newBuilder().setLong(value).build()"
    ...
    const-string/jumbo p1, "newBuilder().setString(value).build()"
    ...
    .line 80
    const-string/jumbo p1, "newBuilder().setStringSet(\n                    StringSet.newBuilder().addAllStrings(value as Set<String>)\n                ).build()"
